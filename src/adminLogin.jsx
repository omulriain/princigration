    ...
    return (
        <>
            ...
            <section className="ps-5 pe-5">
                <h1 className="font-weight-bold basic-padding-top">Princigration Administrator Login</h1>
                <Form className="basic-padding-top">
                    ...
                    <Form.Group controlId="formVerifyCheckbox">
                        <Form.Check className="pt-2" type="checkbox" label="I agree that I am a Princigration administrator." />
                    </Form.Group>
                    <div className="pt-2">
