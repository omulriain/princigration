                            ...
                            <Card.Body>
                                <ul class="list-group-flush invis-bullet-compensation">
                                    <li class="list-group-item"><img className="rounded-4 border border-success mb-3"
                                        ...
                                        loading="lazy"
                                    /></li>
                                    <li class="list-group-item"><container className="green-font"><h3 className="text-shadow2">Jesse S. Sites</h3><p>
                                    ...
                                    <li class="list-group-item"><div className="fixed-action-button"><button type="button" className="btn">
                                        <a href="https://princigration.s3.us-west-2.amazonaws.com/website/resume_sites.pdf" className="green-font"><h4>
                                            Resume</h4></a></button></div></li>
                                </ul>
                            </Card.Body>
                        </Accordion.Collapse>
